...
export function Sidebar() {
  ...
  return (
    <aside className="hidden h-full w-64 flex-col border-r border-blue-100 bg-white lg:flex">
      {/* Logo */}
      <div className="flex h-16 items-center gap-2 border-b border-blue-100 px-6">
